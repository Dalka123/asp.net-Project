<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Our Team.aspx.vb" Inherits="Hantech.Our_Team" %>
            ...
            <div class="card card-chart">
              <div class="card-header ">
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-center">HanTech Technology Service</h3>
                </div>
                <div class="row">
                    <div class="col-md-3">
                        <div class="team-member">
                            <img class="mx-auto rounded-circle" src="About Team/assets/img/team/Abdiruf.jpeg" alt="" />
                            <h4>Abdiru'uuf Maxamed Shukri</h4>
                            <p class="text-muted">Maneger of Team</p>
                    ...
                    <div class="col-md-3">
                        <div class="team-member">
                            <img class="mx-auto rounded-circle" src="About Team/assets/img/team/Dayib.jpeg" alt="" />
                            <h4>Ahmed Dayib</h4>
                    ...
                    <div class="col-md-3">
                        <div class="team-member">
                            <img class="mx-auto rounded-circle" src="About Team/assets/img/team/Zaki.jpeg" alt="" />
                            <h4>Zakariye Abdi Samow</h4>
                            <p class="text-muted">Member of Groub</p>
                            <a class="btn btn-dark btn-social mx-2" href="#!"><i class="fab fa-twitter"></i></a>
                            <a class="btn btn-dark btn-social mx-2" href="#!"><i class="fab fa-facebook-f"></i></a>
                            <a class="btn btn-dark btn-social mx-2" href="#!"><i class="fab fa-linkedin-in"></i></a>
                        </div>
                      ...
                      <div class="col-md-3">
                        <div class="team-member">
                            <img class="mx-auto rounded-circle" src="About Team/assets/img/team/Manka.jpeg" alt="" />
                            <h4>Abdirahman Ali Adan</h4>
                            <p class="text-muted">Member Of Group</p>
                            <a class="btn btn-dark btn-social mx-2" href="#!"><i class="fab fa-twitter"></i></a>
                            <a class="btn btn-dark btn-social mx-2" href="#!"><i class="fab fa-facebook-f"></i></a>
                            <a class="btn btn-dark btn-social mx-2" href="#!"><i class="fab fa-linkedin-in"></i></a>
                        </div>
